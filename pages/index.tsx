  ...
  return (
    <>
      <>
        <Head>
          <title>Cowork</title>
          <meta property="image" content="/images/preview-image.jpg" />
          <meta property="title" content="Cowork" />
          <meta property="description" content="Elevate Your Workspace with Cowork" />
        </Head>
      </>
      <Layout>
        <section>
