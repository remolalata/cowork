...
const Banner: React.FC = () => {
    return (
        <div className="container py-16 lg:py-28 flex flex-col lg:flex-row items-center justify-between gap-y-10 gap-x-12">
            <div className="text-center lg:text-left">
                <h1 className="font-neue-regrade font-bold text-5xl xl:text-8xl leading-tight lg:leading-tight">
